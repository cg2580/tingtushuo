...
from tingtushuo.blueprints.admin import admin_bp
from tingtushuo.blueprints.ajax import ajax_bp
from tingtushuo.blueprints.auth import auth_bp
from tingtushuo.blueprints.main import main_bp
from tingtushuo.blueprints.user import user_bp
from tingtushuo.extensions import bootstrap, db, login_manager, mail, dropzone, moment, whooshee, avatars, csrf
from tingtushuo.models import Role, User, Photo, Tag, Follow, Notification, Comment, Collect, Permission
from tingtushuo.settings import config
...
def register_commands(app):
    ...
    def forge(user, follow, photo, tag, collect, comment):
        ...
        from tingtushuo.fakes import fake_admin, fake_comment, fake_follow, fake_photo, fake_tag, fake_user, \
            fake_collect
