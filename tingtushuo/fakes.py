...
from tingtushuo.models import User, Photo, Tag, Comment, Notification

fake = Faker()


def fake_admin():
    admin = User(name='TingTuShuo',
                 username='tingtushuo',
                 email='admin@tingtushuo.com',
                 bio=fake.sentence(),
                 website='http://tingtushuo.com',
                 confirmed=True)
    admin.set_password('tingtushuo')
    notification = Notification(message='Hello, welcome to TingTuShuo.', receiver=admin)
