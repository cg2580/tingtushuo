...
from tingtushuo.decorators import confirm_required, permission_required
from tingtushuo.emails import send_change_email_email
from tingtushuo.extensions import db, avatars
from tingtushuo.forms.user import EditProfileForm, UploadAvatarForm, CropAvatarForm, ChangeEmailForm, \
    ChangePasswordForm, NotificationSettingForm, PrivacySettingForm, DeleteAccountForm
from tingtushuo.models import User, Photo, Collect
from tingtushuo.notifications import push_follow_notification
from tingtushuo.settings import Operations
from tingtushuo.utils import generate_token, validate_token, redirect_back, flash_errors
