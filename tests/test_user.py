...
from tingtushuo.models import User, Photo
...
class UserTestCase(BaseTestCase):
    ...
    def test_change_email(self):
        user = User.query.get(2)
        self.assertEqual(user.email, 'normal@tingtushuo.com')
        token = generate_token(user=user, operation=Operations.CHANGE_EMAIL, new_email='new@tingtushuo.com')
