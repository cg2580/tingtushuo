...
from tingtushuo.models import User, Role, Tag
...
class AdminTestCase(BaseTestCase):
    ...
    def setUp(self):
        ...
        self.login(email='admin@tingtushuo.com', password='123')

    def test_index_page(self):
        response = self.client.get(url_for('admin.index'))
        data = response.get_data(as_text=True)
        self.assertIn('TingTuShuo Dashboard', data)
    ...
    def test_bad_permission(self):
        ...
        self.assertNotIn('TingTuShuo Dashboard', data)
    ...
    def test_edit_profile_admin(self):
        ...
        self.assertEqual(user.email, 'new@tingtushuo.com')
